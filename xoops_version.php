...
$modversion['config'][$i]['default']     = array(_MD_KWCLUB_GRADE0, _MD_KWCLUB_GRADE1, _MD_KWCLUB_GRADE2, _MD_KWCLUB_GRADE3,
    _MD_KWCLUB_GRADE4, _MD_KWCLUB_GRADE5, _MD_KWCLUB_GRADE6);
//_MI_KWCLUB_SCHOOL_GV0, _MI_KWCLUB_SCHOOL_GV1, _MI_KWCLUB_SCHOOL_GV2, _MI_KWCLUB_SCHOOL_GV3, _MI_KWCLUB_SCHOOL_GV4, //_MI_KWCLUB_SCHOOL_GV5, _MI_KWCLUB_SCHOOL_GV6);
$modversion['config'][$i]['options'] = array(
    _MD_KWCLUB_GRADE0  => _MD_KWCLUB_GRADE0,
    _MD_KWCLUB_GRADE1  => _MD_KWCLUB_GRADE1,
    _MD_KWCLUB_GRADE2  => _MD_KWCLUB_GRADE2,
    _MD_KWCLUB_GRADE3  => _MD_KWCLUB_GRADE3,
    _MD_KWCLUB_GRADE4  => _MD_KWCLUB_GRADE4,
    _MD_KWCLUB_GRADE5  => _MD_KWCLUB_GRADE5,
    _MD_KWCLUB_GRADE6  => _MD_KWCLUB_GRADE6,
    _MD_KWCLUB_GRADE7  => _MD_KWCLUB_GRADE7,
    _MD_KWCLUB_GRADE8  => _MD_KWCLUB_GRADE8,
    _MD_KWCLUB_GRADE9  => _MD_KWCLUB_GRADE9,
    _MD_KWCLUB_GRADE10 => _MD_KWCLUB_GRADE10,
    _MD_KWCLUB_GRADE11 => _MD_KWCLUB_GRADE11,
    _MD_KWCLUB_GRADE12 => _MD_KWCLUB_GRADE12);
