                    ...
                    <li class="vm w1 text-center">
                        <{if $smarty.session.isclubAdmin}>
                            <{if $data.class_ischecked!=1}>
                                <a href="<{$xoops_url}>/modules/kw_club/club.php?op=class_enable&class_id=<{$data.class_id}>" class="btn btn-xs btn-success" data-toggle="tooltip" data-placement="bottom" title="<{$smarty.const._MB_KWCLUB_CLASS_ENABLE_DESC}>"><{$smarty.const._MB_KWCLUB_CLASS_ENABLE}></a>
                            <{else}>
                                <a href="<{$xoops_url}>/modules/kw_club/club.php?op=class_unable&class_id=<{$data.class_id}>" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="bottom" title="<{$smarty.const._MB_KWCLUB_CLASS_UNABLE_DESC}>"><{$smarty.const._MB_KWCLUB_CLASS_UNABLE}></a>
                            <{/if}>
                            <a href="<{$xoops_url}>/modules/kw_club/club.php?op=class_blank&class_id=<{$data.class_id}>" class="btn btn-xs btn-default" data-toggle="tooltip" data-placement="bottom" title="<{$smarty.const._MB_KWCLUB_CLASS_BLANK_DESC}>"><{$smarty.const._MB_KWCLUB_CLASS_BLANK}></a>
                        <{/if}>

                        <{if $smarty.session.isclubAdmin || $block.uid == $data.class_uid}>
                            <a href="<{$xoops_url}>/modules/kw_club/club.php?class_id=<{$data.class_id}>" class="btn btn-xs btn-warning" <{if !$block.can_operate}>data-toggle="tooltip" data-placement="bottom" title="<{$smarty.const._MB_KWCLUB_OVER_END_TIME}>" disabled<{/if}>><{$smarty.const._TAD_EDIT}></a>
                        ...
                        <{else}>
                            ...
                            <{elseif $data.class_regnum >= $data.class_member}>
                                <a href="<{$xoops_url}>/modules/kw_club/index.php?op=reg_form&class_id=<{$data.class_id}>&is_full=1" class="btn btn-warning btn-xs"><i class="fa fa-user-plus" aria-hidden="true"></i>
                                    <{$smarty.const._MB_KWCLUB_SIGNUP_TO_MAKE_UP}></a>
                            <{elseif $block.chk_time}>
                                <a href="<{$xoops_url}>/modules/kw_club/index.php?op=reg_form&class_id=<{$data.class_id}>" class="btn btn-primary btn-xs"><i class="fa fa-user-plus" aria-hidden="true"></i>
