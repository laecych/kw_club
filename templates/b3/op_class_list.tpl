<div class="row">
        ...
        <div class="col-sm-2" style="padding-top: 40px;">
           <{if $language=="english"}>
            <a href="index.php?language=tchinese_utf8" class="btn btn-primary btn-block" ><i class="fa fa-refresh" aria-hidden="true"></i>
            <{else}>
            <a href="index.php?language=english" class="btn btn-primary btn-block" ><i class="fa fa-refresh" aria-hidden="true"></i>
            <{/if}>    
