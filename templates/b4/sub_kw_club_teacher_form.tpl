    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
             <div class="form-check form-check-inline">
                <input type="radio" name="teacher_enable" id="teacher_enable_1" value="1" <{if $teacher_enable != "0"}>checked="checked"<{/if}>> <label class="form-check-label" for="teacher_enable_1"><{$smarty.const._YES}></label>
                <input type="radio" name="teacher_enable" id="teacher_enable_0" value="0" <{if $teacher_enable == "0"}>checked="checked"<{/if}>> <label class="form-check-label" for="teacher_enable_0"><{$smarty.const._NO}></label>
            </div>
        </div>
    </div>
