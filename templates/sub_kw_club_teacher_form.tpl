    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <label class="radio-inline">
                <input type="radio" name="teacher_enable" id="teacher_enable_1" value="1" <{if $teacher_enable != "0"}>checked="checked"<{/if}>><{$smarty.const._YES}>
            </label>
            <label class="radio-inline">
                <input type="radio" name="teacher_enable" id="teacher_enable_0" value="0" <{if $teacher_enable == "0"}>checked="checked"<{/if}>><{$smarty.const._NO}>
            </label>
        </div>
    </div>
