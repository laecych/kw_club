CREATE TABLE `kw_club_info` (
  `club_id` int(255) NOT NULL AUTO_INCREMENT COMMENT '流水號',
  `club_year` int(20) unsigned NOT NULL COMMENT '社團年度',
  ...
  `club_backup_num` int(10) NOT NULL DEFAULT '2' COMMENT '候補人數',
  `club_uid` int(255) NOT NULL COMMENT '設定者',
